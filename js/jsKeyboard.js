var jsKeyboard = {
    settings: {
        buttonClass: "pixelkey1", // default button class
    ...
    init: function(elem, keyboard) {
        ...
        jsKeyboard.addKeyDownEvent();
         ...
         $(':input').not('[type="reset"]').not('[type="submit"]').on('focus, click', function(e)
         {
			...
			//console.log('not switching focus');            
    ...
    defaultKeyboard: {
        ...
        // 1st row
               ...
               { value: "Delete", isChar: "false", onclick: "jsKeyboard.del()", buttonClass: "pixelkey2", keyClass: "key key_del" },
        // 2nd row
			   { value: "", isChar: "false", buttonClass: "pixelkey0", onclick: "", keyClass: "key" },
               { value: 65, buttonClass: "pixelkey1" },{ value: 83 },{ value: 68 },{ value: 70 },
               { value: 71 },{ value: 72 },{ value: 74 },{ value: 75 },{ value: 76 },
               { value: "Enter", isChar: "false", buttonClass: "pixelkey2", onclick: "jsKeyboard.enter();", keyClass: "key key_enter" },
        // 3rd row
			   { value: "", isChar: "false", buttonClass: "pixelkey0b", onclick: "", keyClass: "key" },
			   { value: "", isChar: "false", buttonClass: "pixelkey0b", onclick: "", keyClass: "key" },
               { value: "abc", isChar: "false", buttonClass: "pixelkey1", onclick: "jsKeyboard.changeToSmallLetter();", keyClass: "key key_smallletter" },
               { value: 90 },{ value: 88 },{ value: 67 },{ value: 86 },{ value: 66 },{ value: 78 },
               { value: 77 },{ value: 44 },{ value: 46 },{ value: 64 },
        // 4th row
		 { value: "", isChar: "false", buttonClass: "pixelkey0", onclick: "", keyClass: "key" },
               { value: "123", isChar: "false", buttonClass: "pixelkey4", onclick: "jsKeyboard.changeToNumber();", keyClass: "key key_number" },
               { value: "Space", isChar: "false", buttonClass: "pixelkey3", onclick: "jsKeyboard.space();", keyClass: "key key_space" },
               { value: "#$+", isChar: "false", buttonClass: "pixelkey5", onclick: "jsKeyboard.changeToSymbols();", keyClass: "key key_symbols" }
            ],
        smallLetter: [
        // 1st row
        ...
        // 2nd row
				{ value: "", isChar: "false", buttonClass: "pixelkey0", onclick: "", keyClass: "key" },
                { value: 97, buttonClass: "pixelkey1" },{ value: 115 },{ value: 100 },{ value: 102 },
                { value: 103 },{ value: 104 },{ value: 106 },{ value: 107 },{ value: 108 },
                { value: "Enter", isChar: "false", buttonClass: "pixelkey2", onclick: "jsKeyboard.enter();", keyClass: "key key_enter" },
        // 3rd row
				{ value: "", isChar: "false", buttonClass: "pixelkey0b", onclick: "", keyClass: "key" },
				{ value: "", isChar: "false", buttonClass: "pixelkey0b", onclick: "", keyClass: "key" },
                { value: "ABC", isChar: "false", buttonClass: "pixelkey1", onclick: "jsKeyboard.changeToCapitalLetter();", keyClass: "key key_capitalletterleft" },
        ...
        // 2nd row
				{ value: "", isChar: "false", buttonClass: "pixelkey0", onclick: "", keyClass: "key" },
                { value: 45, buttonClass: "pixelkey1" },{ value: 47 },{ value: 58 },{ value: 59 },
        ...
        //3rd row
                ...
                { value: "", isChar: "false", buttonClass: "pixelkey1", onclick: "", keyClass: "key" },
        ...
        // 4th row
		 { value: "", isChar: "false", buttonClass: "pixelkey0", onclick: "", keyClass: "key" },
                { value: "ABC", isChar: "false", buttonClass: "pixelkey4", onclick: "jsKeyboard.changeToCapitalLetter();", keyClass: "key key_capitalletterleft" },
                { value: "Space", isChar: "false", buttonClass: "pixelkey3", onclick: "jsKeyboard.space();", keyClass: "key key_space" },
                { value: "#$+", isChar: "false", buttonClass: "pixelkey5", onclick: "jsKeyboard.changeToSymbols();", keyClass: "key key_symbols" }
            ],
        symbols: [
        ...
        // 2nd row
			{ value: "", isChar: "false", buttonClass: "pixelkey0", onclick: "", keyClass: "key" },
            { value: 95, buttonClass: "pixelkey1" },{ value: 92 },{ value: 124 },{ value: 126 },
            { value: 60 },{ value: 62 },
        ...
        // 4th row
		 { value: "", isChar: "false", buttonClass: "pixelkey0", onclick: "", keyClass: "key" },
            { value: "123", isChar: "false", buttonClass: "pixelkey4", onclick: "jsKeyboard.changeToNumber();", keyClass: "key key_number" },
            { value: "Space", isChar: "false", buttonClass: "pixelkey3", onclick: "jsKeyboard.space();", keyClass: "key key_space" },
            { value: "ABC", isChar: "false", buttonClass: "pixelkey5", onclick: "jsKeyboard.changeToCapitalLetter();", keyClass: "key key_capitalletterleft" },
         ]
    }
}
